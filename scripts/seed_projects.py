...
from cenacle.core import Project, atomic
...
if not DEMO.exists():
    p = Project.create(DEMO, "Cenacle / interaction demo", "Explore a shared room for independent agents.", CODE, "Jonathan",
    ...
    p.command("send", {"body": "Welcome to Cenacle. This room contains sample conversations so we can explore how collaboration feels. Real work belongs in the pilot room."}, human=True)
